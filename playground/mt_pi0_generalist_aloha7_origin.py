...
class Pi0TrainerConfig(_Pi0TrainerConfig):
    ...
    output_dir: str = field(
        default=f"/mlp_vepfs/share/yjh/checkpoints/rc_table30_cvpr_generalist/mtvla_pi0/aloha7_origin_{datetime.now().strftime('%m%d')}"
    )
...
class Pi0DataConfig(_Pi0DataConfig):
    dataset_name: str = field(
        default="+".join([
            "table30_cvpr_generalist_aloha_7_lint_roller_remove_dirt",
            "table30_cvpr_generalist_aloha_7_pack_the_items",
            "table30_cvpr_generalist_aloha_7_pack_the_toothbrush_holder",
            "table30_cvpr_generalist_aloha_7_paint_jam",
            "table30_cvpr_generalist_aloha_7_put_the_books_back",
            "table30_cvpr_generalist_aloha_7_put_the_pencil_case_into_the_schoolbag",
            "table30_cvpr_generalist_aloha_7_scoop_with_a_small_spoon",
            "table30_cvpr_generalist_aloha_7_stamp_positioning",
            "table30_cvpr_generalist_aloha_7_wipe_the_blackboard",
            "table30_cvpr_generalist_aloha_7_wrap_with_a_soft_cloth",
        ])
    )
