...
class CausalLMOutputDexbotic(ModelOutput):
    ...
    flow_matching_loss_per_sample: Optional[torch.FloatTensor] = None
    moe_z_loss: Optional[torch.FloatTensor] = None
    moe_load_balancing_loss: Optional[torch.FloatTensor] = None
    moe_activation_square_sum: Optional[torch.FloatTensor] = None
    moe_norm: Optional[torch.FloatTensor] = None
    router_norm: Optional[torch.FloatTensor] = None
    total_param_norm: Optional[torch.FloatTensor] = None
